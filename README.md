# 加密交換/硬幣交換
# 可能是全網最好的開源核心代碼交換，架構/代碼質量可見一斑。
# 我覺得這可能是你搭建交易所或者二次開發的最佳選擇

陳述1：我一直在新公司工作。我會花時間在這裡更新一些描述性的東西，以便大家編譯，構建和開發
聲明2：APP源代碼和交易機器人源代碼不是開源的（收費提供），如有需要，電子郵件：837385225@qq.com

我是中國人，所以中文是我的母語，但我也可以用英語和日語和你交流。
介紹
本項目是一個基於Java（SpringCloud）的比特幣交易所| 比特幣交易所 | ETH 交易所 | 數字貨幣兌換| 交易平台| 匹配交易引擎。本項目基於Spring Cloud微服務開發，可用於搭建和二次開發數字貨幣交易所，具有完整的系統組件。
